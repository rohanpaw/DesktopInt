...
namespace Fireclass.SpainFCRecordingsModule
{
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The Verify_FIM_Series_Panel_Gallery_Items_For_Main_Processor_And_SerialPort_Node recording.
    /// </summary>
    [TestModule("170144fc-d8ff-42ec-827f-8869eb9bd64c", ModuleType.Recording, 1)]
    public partial class Verify_FIM_Series_Panel_Gallery_Items_For_Main_Processor_And_SerialPort_Node : ITestModule
    {
        /// <summary>
        ...
        static Verify_FIM_Series_Panel_Gallery_Items_For_Main_Processor_And_SerialPort_Node instance = new Verify_FIM_Series_Panel_Gallery_Items_For_Main_Processor_And_SerialPort_Node();

        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public Verify_FIM_Series_Panel_Gallery_Items_For_Main_Processor_And_SerialPort_Node()
        {
        }
        ...
        /// </summary>
        public static Verify_FIM_Series_Panel_Gallery_Items_For_Main_Processor_And_SerialPort_Node Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            TestProject.Libraries.Gallery_Functions.verifyGalleryListItems("FC_Gallery_MainProcessor_Repeaters_FIM_Series_Panels", "Spain", "FC32AR");
            Delay.Milliseconds(0);
            
            TestProject.Libraries.Gallery_Functions.verifyGalleryListItems("FC_Gallery_Miscellaneous_FC_Series_Panels", "Spain", "FC1D2");
            Delay.Milliseconds(0);
            
            TestProject.Libraries.Gallery_Functions.verifyGalleryListItems("FC_Gallery_Printers_FIM_Series_Panels", "Spain", "Generic Printer");
            Delay.Milliseconds(0);
            ...
            TestProject.Libraries.Gallery_Functions.verifyGalleryListItems("FC_Gallery_MPM_AttachedFunctionality_FIM_Series_Panels", "Spain", "Zonal Alarm Display max 80");
            Delay.Milliseconds(0);
            
            TestProject.Libraries.Devices_Functions.AddDevicesfromGallery("FC1D2", "");
            Delay.Milliseconds(0);
            
            TestProject.Libraries.Gallery_Functions.verifyGalleryListItems("FC_Gallery_FC1D2_AttachedFunctionality", "Spain", "FCZ4DS");
            Delay.Milliseconds(0);
            ...
            Report.Log(ReportLevel.Info, "Section", "ADDED STEPS FOR ANOTHER PANEL", new RecordItemIndex(21));
            
            TestProject.Libraries.Panel_Functions.AddPanelsFC(ValueConverter.ArgumentFromString<int>("NumberofPanels", "1"), "FC240-4", "");
            Delay.Milliseconds(0);
