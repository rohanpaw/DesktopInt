...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Libraries.Devices_Functions.AddDevicesfromGallery("410RIM", "Detectors");
            Delay.Milliseconds(0);
            
            Libraries.IS_Functions.VerifyIsolatorUnits("8", "FIM");
            Delay.Milliseconds(0);
            ...
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'FormMe.ButtonCut1' at Center.", repo.FormMe.ButtonCut1Info, new RecordItemIndex(11));
            repo.FormMe.ButtonCut1.Click();
            Delay.Milliseconds(200);
            
            Libraries.IS_Functions.VerifyIsolatorUnits("36", "FIM");
            Delay.Milliseconds(0);
