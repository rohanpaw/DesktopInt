...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Libraries.Panel_Functions.AddPanelsHighPowerLoops(ValueConverter.ArgumentFromString<int>("NumberofPanels", "1"), "Pro32xD");
            Delay.Milliseconds(0);
            ...
            //Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'FormMe.btn_MultiplePointWizard' at Center.", repo.FormMe.btn_MultiplePointWizardInfo, new RecordItemIndex(6));
            //repo.FormMe.btn_MultiplePointWizard.Click();
            //Delay.Milliseconds(0);
            
            Libraries.DC_Functions.verifyMTPanelPowerCalculations("abcd", "801 CH");
            Delay.Milliseconds(0);
