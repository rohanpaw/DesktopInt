...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The Verify_Trip_Current_FIM recording.
    /// </summary>
    [TestModule("25f38091-80a0-4e7d-8b04-2bd59fe18892", ModuleType.Recording, 1)]
    public partial class Verify_Trip_Current_FIM : ITestModule
    {
        /// <summary>
        ...
        static Verify_Trip_Current_FIM instance = new Verify_Trip_Current_FIM();

        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public Verify_Trip_Current_FIM()
        {
        }
        ...
        /// </summary>
        public static Verify_Trip_Current_FIM Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Libraries.Common_Functions.Application_Close(ValueConverter.ArgumentFromString<bool>("Save", "True"), ValueConverter.ArgumentFromString<bool>("SaveConfirmation", "True"), "NGC-1400");
            Delay.Milliseconds(0);
