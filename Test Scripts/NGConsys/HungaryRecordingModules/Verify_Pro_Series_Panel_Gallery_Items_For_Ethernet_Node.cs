...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    ...
    /// </summary>
    [TestModule("d4b44205-77b6-4517-8786-59e9e6b7eb78", ModuleType.Recording, 1)]
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Libraries.Gallery_Functions.verifyGalleryListItems("Gallery_Ethernet_ProPanels", "Hungary", "PR8AS");
            Delay.Milliseconds(0);
            
            Libraries.Devices_Functions.AddDevicesfromGallery("PR1DS", "");
            Delay.Milliseconds(0);
            
            Libraries.Gallery_Functions.verifyGalleryListItems("Gallery_Ethernet_AttachedFunctionality_ProPanels", "Hungary", "PZ8DS");
            Delay.Milliseconds(0);
