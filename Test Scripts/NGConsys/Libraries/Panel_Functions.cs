...
//			
		 ...
		 /**********************************************************************************************************************************
         * Function Name: AddMTPanelsHighPowerLoops
         * Function Details:Add MT2 Panel with High Power Loop
         * Parameter/Arguments:
         * Output:
         * Function Owner: Juily Narendra Sukalkar
         * Last Update : 17/05/2021
         **********************************************************************************************************************************/
       [UserCodeMethod]
        public static void AddPanelsMTHighPower(int NumberofPanels,string PanelName,string sPanelCPU)
        {
            for (int i=0; i<NumberofPanels;i++)
            {
//                string[] splitPanelNames = PanelNames.Split(',');
