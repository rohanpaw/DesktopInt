...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    ...
    /// </summary>
    [TestModule("a76fa923-fc23-4251-b5ce-637be788c605", ModuleType.Recording, 1)]
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Libraries.Gallery_Functions.verifyGalleryListItems("Gallery_SlotCards", "Russia", "PCH800 5.0A");
            Delay.Milliseconds(0);
            ...
            // ---------Another Panel Execution-------------------------------------------
            Report.Log(ReportLevel.Info, "Section", "---------Another Panel Execution-------------------------------------------", new RecordItemIndex(30));
